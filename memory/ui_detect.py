...
try:
    ...
    HAS_OCR = False
    print("Warning: rapidocr not installed, skipping OCR functionality")

def detect_ui_elements(image_path, model_path=None, conf_threshold=0.25):
    model_path = model_path or DEFAULT_MODEL
    """Detect UI elements and return bounding boxes"""
    # Load model
